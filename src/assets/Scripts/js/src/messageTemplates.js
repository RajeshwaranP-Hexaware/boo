...
define(["utils", "settings"], function (utils, settings) {
    ...
    methods.userplaintext = (data) => {
        let html = `<li class="list-group-item background-color-custom" style = "margin : initial">
    ...
    methods.quickreplies = (data) => {
        var quickRepliesHtml = `<li class="list-group-item background-color-custom" style = "margin : initial">
    ...
    methods.multiplequickreplyfromapiai = (data) => {
        var apiquickRepliesHtml = `<li class="list-group-item background-color-custom" style = "margin : initial">
